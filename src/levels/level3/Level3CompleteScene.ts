...
export class Level3CompleteScene extends Phaser.Scene {
  ...
  private createPerfumeRoom(w: number, h: number): void {
    ...
    g.fillStyle(LEVEL3.fragment.color, 0.8)
    ...
    g.fillStyle(LEVEL3.fragment.color, 0.72)
  ...
  private createFragment(w: number, h: number): void {
    ...
    frag.setDepth(5)
    frag.fillStyle(LEVEL3.fragment.color, 0.82)
    ...
    this.add.text(cx, cy + 86, LEVEL3.fragment.description, {
      fontSize: '13px',
      color: '#e8d9be',
      fontFamily: 'Georgia, serif',
      fontStyle: 'italic',
